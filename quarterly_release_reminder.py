...
Creates a Jira ticket in YOUR_RELEASE_PROJECT for the Oracle quarterly release summary
and posts a Slack reminder to #oci-admin mentioning the assignee.
...
JIRA_PARENT      = "<your-release-epic-key>"  # Oracle Quarterly Releases epic
ASSIGNEE_ACCOUNT_ID = os.environ.get("OCI_ADMIN_RELEASE_ASSIGNEE_ID", "")
...
def main():
    ...
    mention = slack_user_id(ASSIGNEE_EMAIL)
