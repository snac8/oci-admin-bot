...
DEV2_OCID         = os.environ.get("DEV2_OCID",  "")
PROD_OCID         = os.environ.get("PROD_OCID",  "")
DEV2_URL          = os.environ.get("DEV2_URL",   "https://your-dev2-tenant.oraclecloud.com/")
...
def main():
    ...
    if args.mode == "check-reminder":
        ...
        actual_refresh_date = datetime.fromisoformat(state_scheduled_start).date()
